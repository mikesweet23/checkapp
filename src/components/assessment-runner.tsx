...
import type { Assessment, ParticipantDetails } from "@/src/lib/types";
...
export function AssessmentRunner({ assessment }: { assessment: Assessment }) {
  ...
  const next = async () => {
    if (answer === undefined || !participant || isSaving) return;
